...
const TenantsList = ({ serverMode }: { serverMode: Mode }) => {
  ...
  const columns = useMemo<ColumnDef<Tenant, any>[]>(
    () => [
      ...
      columnHelper.accessor('rent_start_date', {
        header: 'Rent Start',
        cell: ({ row }) => (
          <Typography>
            {new Date(row.original.rent_start_date).toLocaleDateString('en-US', {
              year: 'numeric',
              month: 'short',
              day: 'numeric'
            })}
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-2'>
            <IconButton
              size='small'
              onClick={() => router.push(`/en/apps/rentals/tenants/details/${row.original.id}`)}
              title='View Details'
            >
            ...
            <IconButton
              size='small'
              onClick={() => router.push(`/en/apps/rentals/tenants/edit/${row.original.id}`)}
              title='Edit Tenant'
            >
    ...
    <Card>
      <div className='flex flex-wrap items-center justify-between gap-4 p-6'>
        ...
        <Button
          variant='contained'
          component={Link}
          href='/en/apps/rentals/tenants/add'
      ...
      <Dialog open={deleteDialogOpen} onClose={() => !deleting && setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete <strong>{tenantToDelete?.full_name}</strong>? This action cannot be undone.
          </Typography>
        </DialogContent>
        <DialogActions>
