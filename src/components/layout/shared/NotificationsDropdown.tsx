...
const NotificationDropdown = () => {
  ...
  const { notifications: apiNotifications, unreadCount, markAsRead, markAllAsRead, deleteNotification } = useNotifications()
  
  // States
  const [open, setOpen] = useState(false)

  // Convert API notifications to UI format
  const notificationsState: NotificationsType[] = apiNotifications.map((notif: Notification) => {
                ...
                <div className='bs-full flex flex-col'>
                  ...
                  <div className='p-4'>
                    <Button 
                      ...
                      size='small'
                      onClick={() => {
                        router.push('/en/apps/rentals/notifications')
                        setOpen(false)
                      }}
                    >
