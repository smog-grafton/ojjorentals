...
const ShortcutsDropdown = ({ shortcuts: propShortcuts }: { shortcuts?: ShortcutsType[] }) => {
  // States
  const [open, setOpen] = useState(false)
  const [shortcuts, setShortcuts] = useState<ShortcutsType[]>(propShortcuts || [])
  const [loading, setLoading] = useState(!propShortcuts)
